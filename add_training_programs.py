"""
Script to Add New Training Programs to Database
Run this script: python add_training_programs.py
"""
...
print("=" * 70)
print("📚 ADDING NEW TRAINING PROGRAMS")
print("=" * 70)

# New training programs to add
new_programs = [
    {
...
print("2. Programs will automatically appear in the training page")
