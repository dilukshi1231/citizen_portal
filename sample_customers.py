...
File: sample_customers.py
Run: python sample_customers.py
"""
...
# ============================================
# 1. GOVERNMENT EMPLOYEES WITHOUT DEGREES
# Target: Degree completion programs
# ============================================
print("\n📊 Creating government employees without degrees...")
...
# Target: Career development, overseas opportunities
# ============================================
...
# Target: Education services, tuition, exam prep
# ============================================
print("\n📊 Creating parents with school-going children...")
    ...
    customer = {
        ...
        "extended_profile": {
            "family": {
                ...
                "children_ages": children_ages,
                "children_education": [
                    random.choice(["primary", "secondary", "ol_prep", "al_prep", "tuition"]) 
                    for _ in range(children_count)
                ],
                "dependents": children_count
            },
...
if sample_customers:
    ...
    print(f"\n🎉 TOTAL: Inserted {len(sample_customers)} sample customers")
