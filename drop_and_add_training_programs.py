"""
Script to DROP existing programs and ADD new ones with enrollment enabled
Run this script: python drop_and_add_training_programs.py
"""
...
print("=" * 70)
print("🗑️  DROP & RE-ADD TRAINING PROGRAMS")
print("=" * 70)

# List of program IDs to drop and re-add
program_ids_to_replace = [
    "train_python_programming_01",
    "train_data_analytics_01",
    "train_graphic_design_01",
    "train_digital_marketing_01",
    "train_english_speaking_01",
    "train_web_development_01",
    "train_accounting_basics_01",
    "train_mobile_photography_01",
    "train_freelancing_guide_01",
    "train_video_editing_01"
]

# Step 1: Delete existing programs
print(f"\n🗑️  Deleting {len(program_ids_to_replace)} existing programs...")
delete_result = training_programs_col.delete_many({"id": {"$in": program_ids_to_replace}})
print(f"✅ Deleted {delete_result.deleted_count} programs")

# Step 2: Delete any enrollments for these programs (optional, but clean)
print(f"\n🧹 Cleaning up enrollments for deleted programs...")
enrollment_delete = enrollments_col.delete_many({"program_id": {"$in": program_ids_to_replace}})
print(f"✅ Cleaned up {enrollment_delete.deleted_count} enrollments")

# Step 3: Add new programs with enrollment_open=True
print(f"\n📝 Adding {len(program_ids_to_replace)} new programs with enrollment enabled...")
...
result = training_programs_col.insert_many(new_programs)
print(f"✅ Successfully added {len(result.inserted_ids)} programs with enrollment enabled!")

# Also fix any other existing programs that might not have enrollment_open
print(f"\n🔧 Updating any other existing programs...")
fix_result = training_programs_col.update_many(
    {"enrollment_open": {"$exists": False}},
    {"$set": {"enrollment_open": True}}
)
print(f"✅ Updated {fix_result.modified_count} other programs")

# Print summary
print("\n" + "=" * 70)
print("📊 FINAL TRAINING PROGRAMS SUMMARY")
print("=" * 70)
...
print("\n" + "=" * 70)
print("✅ DROP & RE-ADD COMPLETE!")
print("=" * 70)
print("\n📌 Next steps:")
print("1. Refresh your browser")
print("2. Visit http://localhost:5000/training")
print("3. All programs should now show 'View Details & Enroll' button")
print("4. Users can now enroll in all programs!")
print("=" * 70)